      ...
      <nav className="container max-w-7xl flex items-center justify-between gap-4 py-3 md:py-4">
        ...
        >
          ...
          <div className="leading-tight">
            ...
            <p className="text-[0.68rem] font-medium uppercase tracking-[0.18em] text-textSecondary-light dark:text-textSecondary">
              TDz
            </p>
          </div>
        </div>
        ...
        <div className="hidden items-center gap-3 md:flex">
          ...
          <button
            type="button"
            className="relative rounded-full p-2 transition-colors hover:bg-gray-200 dark:hover:bg-white/10"
            onClick={() => toggleModal('showNotifications')}
          >
            <svg className="w-5 h-5 text-textSecondary-light dark:text-textSecondary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <button
            type="button"
            className="rounded-full border border-borderColor-dark/40 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em]"
            onClick={() => toggleModal('showSearch')}
          >
            Search
          </button>
          <button
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="text-xs font-medium text-textSecondary-light dark:text-textSecondary hidden lg:block">{user.name}</span>
              <svg className={`w-4 h-4 text-textSecondary-light dark:text-textSecondary transition-transform ${isProfileOpen ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {isProfileOpen && (
              <div className="absolute right-0 mt-2 w-64 rounded-xl bg-white dark:bg-slate-900 border border-gray-200 dark:border-primary-gold/20 shadow-2xl overflow-hidden">
                <div className="p-4 border-b border-gray-200 dark:border-borderColor-dark/40">
                  ...
                  <p className="text-xs text-textSecondary-light dark:text-textSecondary">{user.email}</p>
        ...
        <div className="flex items-center gap-2 md:hidden">
          ...
          <button
            type="button"
            className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-borderColor-dark/70 bg-black/60 text-textSecondary-light dark:text-textSecondary transition-colors duration-150 hover:border-primary-gold hover:text-primary-gold"
