...
const CallToAction = () => {
  return (
    <section className="rounded-3xl border border-borderColor-light dark:border-borderColor-dark/70 bg-card-light text-black dark:bg-card/80 dark:text-textPrimary px-6 py-10 text-center shadow-card sm:px-10">
      <p className="text-xs font-semibold uppercase tracking-[0.22em] text-primary-gold">
        Final call to action
      </p>
      <h2 className="mt-3 font-heading text-2xl font-semibold tracking-tight text-black md:text-3xl">
        Ready to build with confidence?
      </h2>
      <p className="mx-auto mt-3 max-w-xl text-sm text-black">
